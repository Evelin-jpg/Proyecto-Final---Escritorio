...
namespace ProjectBD_RIOJAS
{
    public partial class DocumentType : MaterialSkin.Controls.MaterialForm
    {
        ...
        public DataTable llenar_grid()
        {
            ...
            string consulta = "SELECT * FROM [10.235.242.164].SchoolServices.dbo.DocumentType";
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO [10.235.242.164].SchoolServices.dbo.DocumentType (Name, Description) VALUES(@Name,@Description)";
        ...
        {
            Conexion.Conectar();
            string actualizar = "UPDATE [10.235.242.164].SchoolServices.dbo.DocumentType SET " +
                                 "Name=@Name, " +
